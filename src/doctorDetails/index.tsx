...
const Container = styled('div')<any>(({ padding }) => ({
  maxWidth: '1200px',
  width: '100%',
  padding: '20px',
}));

const CardStyled = styled('div')<any>(({ padding }: any) => ({
...
const Text = styled('p')<any>(({ padding }: any) => ({
  color: '#666666',
  fontSize: '16px',
  padding,
}));
                  ...
                  <CardStyled>
                    ...
                    <GridContainer container spacing={2}>
                      ...
                      <Grid item xs={8}>
                        <Grid container spacing={1}>
                          <Grid item xs={12}>
                            <Text>Obstetrics & Gynaecology</Text>
                          </Grid>
                          <Grid item xs={12}>
                    ...
                    <GridContainer container spacing={2}>
                      ...
                      <Grid item xs={8}>
                        <Grid container spacing={1}>
                          <Grid item xs={12}>
                            <Text>meerut uttar pradesh Indian 180025</Text>
                          </Grid>
                        </Grid>
                      </Grid>
                    </GridContainer>
                    ...
                    <GridContainer container spacing={2}>
                      ...
                      <Grid item xs={8}>
                        <Grid container spacing={1}>
                          <Grid item xs={12}>
                            <a href='https://codewora.com/' target={'_parent'}>
                              <Text>codewora.com</Text>
                            </a>
                          </Grid>
                        </Grid>
                      </Grid>
